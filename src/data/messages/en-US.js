module.exports = {
  cookieConsent:
    'In order to optimize the website, user experience and services for you, cookies are being used. By continuing to use the website, you <1></1>.',
  cookieConsentLink: 'agree to the use of cookies.',
